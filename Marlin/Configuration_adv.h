 ...
 */
  ...
  #define THERMAL_PROTECTION_PERIOD 60        // Seconds // tiago 40
  #define THERMAL_PROTECTION_HYSTERESIS 4     // Degrees Celsius //tiago 4
 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD        20 // Seconds //tiago 20
  #define THERMAL_PROTECTION_BED_HYSTERESIS     2 // Degrees Celsius //tiago 2

  /**
   * As described above, except for the bed (M140/M190/M303).
   */
  #define WATCH_BED_TEMP_PERIOD                60 // Seconds 
  #define WATCH_BED_TEMP_INCREASE               2 // Degrees Celsius //tiago 2
#endif
...
//#define RX_BUFFER_MONITOR TIAGO
 ...
 */
  ...
  #define INTERPOLATE      true //TIAGO
    ...
    #define Y_MICROSTEPS     32        // 0..256 //16 tiago
    ...
    #define Z_MICROSTEPS     32        // 0..256 //16 tiago
    ...
    #define E0_MICROSTEPS    32        // 0..256 //16 tiago
   ...
   */
  #define SOFTWARE_DRIVER_ENABLE //TIAGO
